...
env.WordHelperUnbeatable.SelectTopProCandidates = function(candidateList)
    ...
    local function better(a, b)
        -- V19.2: user-confirmed Pro-exclusive dictionary entries must remain
        -- visible whenever they match the current prompt. They are never available
        -- outside Pro Unbeatable.
